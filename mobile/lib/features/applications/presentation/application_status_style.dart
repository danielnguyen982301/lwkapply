...
extension ApplicationStatusStyle on ApplicationStatus {
  Color backgroundColor(BuildContext context) {
    ...
    return switch (this) {
      ...
      ApplicationStatus.withdrawn => scheme.surfaceContainerHighest,
      ApplicationStatus.applied => Colors.blue.shade50,
      ApplicationStatus.phoneScreen ||
      ApplicationStatus.interviewing => Colors.orange.shade50,
      ApplicationStatus.offer ||
      ApplicationStatus.accepted => Colors.green.shade50,
  ...
  Color foregroundColor(BuildContext context) {
    ...
    return switch (this) {
      ApplicationStatus.saved ||
      ApplicationStatus.withdrawn => scheme.onSurfaceVariant,
      ApplicationStatus.applied => Colors.blue.shade800,
      ApplicationStatus.phoneScreen ||
      ApplicationStatus.interviewing => Colors.orange.shade800,
      ApplicationStatus.offer ||
      ApplicationStatus.accepted => Colors.green.shade800,
